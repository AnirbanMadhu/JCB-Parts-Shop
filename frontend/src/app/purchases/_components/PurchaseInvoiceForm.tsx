    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Link href="/purchases/invoices" className="text-sm underline dark:text-blue-400">
            ← Back
          </Link>
          <h1 className="text-xl font-semibold dark:text-white">New Purchase Invoice</h1>
        </div>
        <div className="flex items-center gap-2">
          <button
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        ...
        <div className="flex flex-col">
          <label className="text-xs text-neutral-500 dark:text-neutral-400">Supplier</label>
          {supplier ? (
            <div className="flex items-center gap-2">
