            ...
            <div className="relative">
              ...
              {password && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors touch-manipulation z-20 cursor-pointer"
                >
                  {showPassword ? (
