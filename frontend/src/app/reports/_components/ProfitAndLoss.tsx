...
export default function ProfitAndLossPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-white dark:bg-slate-900 overflow-x-hidden">
      {/* Header */}
      <header className="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 px-4 sm:px-6 py-3.5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <h1 className="text-[17px] font-semibold text-gray-900 dark:text-white truncate">Profit And Loss</h1>
        </div>
