    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 py-6">
        <div className="bg-white">
          {/* Table Header */}
          <div className="grid grid-cols-[60px_repeat(3,1fr)_200px] gap-4 px-4 py-3 border-b border-gray-200">
            ...
            <div className="text-xs font-medium text-gray-500 text-right">Outstanding Amount</div>
          </div>
